import { smsg } from '../media/lib/simple.js'
...
export async function handler(chatUpdate) {
    ...
    try {
        ...
        const ___dirname = path.join(path.dirname(fileURLToPath(import.meta.url)), '../media/data')
                ...
                try {
                    ...
                    if (e) {
                        ...
                        for (let key of Object.values(global.APIKeys))
                            text = text.replace(new RegExp(key, 'g'), '#Naomi#')
                        m.reply(text)
                    }
                } finally {
        ...
        try {
            if (!opts['noprint']) await (await import(`../media/lib/print.js`)).default(m, this)
        } catch (e) {
